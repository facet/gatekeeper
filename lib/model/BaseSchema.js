...
function MakeBaseSchema(options){
  ...
  var BaseSchema = function() {
    ...
    // this.methods.cascadeGroups = function(groups) {
    //   console.log('in BaseSchema::cascadeGroups ');
    //   console.log('');
    //   console.log('');

    //   for (var i = this.groups.length - 1; i >= 0; i--) {
    //     // caculate the current group's cascaded permissions
    //     this.groups[i].cascadeGroups();
    ...
    // this.methods.cascadePermission = function( action, level, appId ) {
