 ...
 *                         note: you should check _this.doAccessCheck to 
 *                         decide if auth should be done (see implementation below)
 *
 * @return {function}
 */
exports = module.exports = function(_this) {

  console.log('about to return connect auth middleware function');
  /**
