...
UsersAPI.prototype.setupRouterManifest = function () {
  ...
  this.routerManifest
    ...
    .setRouteBase('/users')
    .setRoutes([
      { verb: 'GET',    route: '/:itemId', emit: 'facet:user:findone' },  // GET a single user by id
      { verb: 'GET',    route: '',         emit: 'facet:user:find'    },  // GET an array of user objects 
      { verb: 'POST',   route: '',         emit: 'facet:user:create'  },  // POST new user
      { verb: 'PUT',    route: '/:itemId', emit: 'facet:user:update'  },  // PUT single/multiple users
      { verb: 'DELETE', route: '/:itemId', emit: 'facet:user:remove'  },  // DELETE a single user resource
    ])
